...
<div class="top-bar" wire:ignore>
  ...
  <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right"
      class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">{{ ucfirst($menu) }}</a> </div>
  <!-- END: Breadcrumb -->
  <!-- BEGIN: Account Menu -->
      ...
      <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
        <div class="p-4 border-b border-theme-27 dark:border-dark-3">
          ...
          <div class="text-xs text-theme-28 mt-0.5 dark:text-gray-600">
            {{ auth()->user()->role == 0 ? 'Administrator' : 'Member' }}</div>
        </div>
        @if (auth()->user()->role == 1)
          <div class="p-2">
            <a href="/profile"
            ...
            <a href="mailto:support@solutionstake.com"
              class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
