        ...
        @if (!auth()->user()->invalid_at)
          <div class="modal-body text-center">
            <div class="form-group mb-2">
              ...
              <select data-placeholder="Package" wire:model="contract" class="form-control form-control-sm">
          ...
          <div class="modal-footer text-center">
            <input type="submit" wire:click.prevent="restakeSubmit" class="mt-4 btn btn-success" value="Claim Now">
          </div>
        @endif
      </form>
    </div>
