<div class="modal fade" wire:ignore.self id="profileModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-content">
      <form>
        ...
        <div class="modal-body">
          ...
          <div class="form-group mb-2">
            <label for="walletProfile" class="form-label">USDT Wallet <small class="text-danger">(BEP
                20)</small></label>
            <input id="walletProfile" type="text" class="form-control text-gray-700" wire:model.defer="walletProfile"
              placeholder="BEP-20 Wallet">
            @error('walletProfile')
              <span class="text-danger">This field is required</span>
            @enderror
          </div>
          <div class="form-group mb-2">
            ...
            <input id="referralProfile" type="text" class="form-control"
              value="{{ auth()->user()->upline ? auth()->user()->upline->username : '' }}" placeholder="Upline"
              readonly>
          </div>
