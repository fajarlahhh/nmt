            ...
            <form class="text-left" wire:submit.prevent="submit">
              <div class="form">
                ...
                <div id="fullname-field" class="field-wrapper input">
                  ...
                  <input id="name" wire:model.defer="name" type="text" class="form-control" placeholder="Full Name">
                  @error('name')
                    <span class="text-danger">This field is required</span>
                  @enderror
                </div>
                ...
                <div id="password-field" class="field-wrapper input ">
                  ...
                  <input id="password" wire:model.defer="password" type="password" value="" placeholder="Password">
                  @error('password')
                    <span class="text-danger">This field is required</span>
                  @enderror
                </div>
                ...
                <div class="field-wrapper terms_condition mt-4">
                  <div class="n-chk new-checkbox checkbox-outline-primary">
                    <label class="new-control new-checkbox checkbox-outline-primary">
                      ...
                      <span class="new-control-indicator"></span><span>I agree to the <a href="javascript:void(0);">
