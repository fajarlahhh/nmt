                                        ...
                                        <div class="col-span-12 sm:col-span-12 xl:col-span-3 intro-y">
                                            <div class="report-box zoom-in">
                                                <div class="box p-5">
                                                    ...
                                                    <div class="text-2xl font-bold leading-8 mt-6 text-right">$ {{ number_format($contract, 2) }} + <small>$ {{ number_format($benefit, 2) }}</small></div>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="report-box zoom-in">
                                                <div class="box p-5 bg-slate-700">
                                                    <div class="flex">
                                                        ...
                                                        <div class="ml-auto">
                                                            <i data-feather="inbox" class="report-box__icon text-theme-11"></i>
                                                        </div>
                                                    </div>
                                                    <div class="text-2xl font-bold leading-8 mt-6 text-right">$ {{ number_format($active_income->sum('credit') - $active_income->sum('debit'), 2) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="overflow-x-auto" id="responsive-table">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="border-b-2 dark:border-dark-5 whitespace-nowrap">
                                                                {{ $row->wallet }} = {{ number_format($row->usdt_amount, 4) }} USDT
                                                            </td>
                                                            <td class="border-b-2 dark:border-dark-5 whitespace-nowrap">
                                                                @if ($row->processed_at)
                                                                    Success at {{ $row->processed_at }}, TX ID : {{ $row->txid }}
                                                                @else
                                                                    Waiting...
                                                                @endif
                                                            </td>
