    ...
    <div class="flex">
        ...
        <nav class="side-nav">
            <a href="" class="intro-x flex items-center pl-5 pt-4">
                <img alt="{{ config('app.name') }}" class="w-6" src="/images/logo.png">
                <span class="hidden xl:block text-white text-lg ml-3"> Solution<span class="font-medium">Stake</span>
                </span>
            </a>
        ...
        <div class="content">
            ...
            <div class="top-bar">
                ...
                <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i
                        ...
                        class="breadcrumb--active">Activation</a> </div>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Account Menu -->
                <div class="intro-x dropdown w-8 h-8">
                    ...
                    <div class="dropdown-menu w-56">
                        <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                            ...
                            <div class="p-2">
                                <a href="mailto:support@solutionsystem  .com"
                    ...
                    @else
                        @if (!auth()->user()->activated_at)
                            <div class="alert alert-warning show">
                                <h1 class="text-center">Your account has not been activated. Please contact admin
                                </h1>
                            </div>
                        @endif
                    @endif
