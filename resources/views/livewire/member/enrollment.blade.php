                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td width="50%" class="border border-b-2 dark:border-dark-5 whitespace-nowrap">
                                ...
                                <small>(The amount of USDT to be transferred must match the amount)</small>&nbsp;<button
                                    type="button" class="btn btn-xs btn-danger" wire:click="cancel()">Cancel</button>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" class="border border-b-2 dark:border-dark-5 whitespace-nowrapt text-center">
                                <form wire:submit.prevent="done">
                                    <input wire:model.defer="information" class="form-control mt-3" cols="30" rows="2"
                        ...
                        <div class="col-span-12 lg:col-span-6">
                            <div class="alert alert-primary show">
                                <div wire:ignore>
                                    ...
                                    <select data-placeholder="Contract" id="upline"
                                        class="form-select text-gray-700 border-gray-300" onchange="setUpline(this)"
                                        required>
                                ...
                                <div class="mt-3">
                                    ...
                                    <select data-placeholder="Contract" id="contract" wire:model.defer="contract"
                                        class="form-select text-gray-700 border-gray-300" required>
