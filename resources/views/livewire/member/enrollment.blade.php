<div>
  @push('css')
    ...
    <link rel="stylesheet" type="text/css" href="/plugins/css/dark/vanillaSelectBox/custom-vanillaSelectBox.css">
  @endpush
  <!--  BEGIN CONTENT AREA  -->
                    ...
                    <tr>
                      <td colspan="2" class="border border-b-2 dark:border-dark-5 whitespace-nowrapt text-center">
                        <form wire:submit.prevent="done">
                          ...
                          @enderror
                          <input type="submit" class="btn btn-success mt-3" value="Done">&nbsp;<button type="button"
              ...
              @else
                <form wire:submit.prevent="submit">
                  ...
                  <div class="form-group mb-2">
                    ...
                    <div class="input-group">
                      <input id="crud-form-3" type="{{ $type }}" class="form-control"
                        wire:model.defer="password" aria-describedby="input-group-1" placeholder="Password"
                        autocomplete="off">
                      <a href="javascript:;" id="input-group-1" wire:click="showHide('{{ $show }}')"
                        class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                  ...
                  <div class="form-group mb-2">
                    ...
                    <select class="form-control" wire:model.defer="contract" id="exampleFormControlSelect1">
  ...
  <!--  END CONTENT AREA  -->
  @push('scripts')
    <script src="/plugins/src/vanillaSelectBox/vanillaSelectBox.js"></script>
    <script src="/plugins/src/vanillaSelectBox/custom-vanillaSelectBox.js"></script>
    <script>
